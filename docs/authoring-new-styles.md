...
- Template asset in `assets/`
- Machine-readable spec `styles/{CODE}.yaml` with: `code`, `name`, `template`, `use_for`, `palette` (hex values), `typography`, `composition`, `text_density`, `line_quality`, `failure_modes`
...
- `SKILL.md` — add a row to the **style-selection table** (most-forgotten step)
- `styles/{CODE}.yaml`
- `references/style-library.md`
- `references/content-distillation.md`
