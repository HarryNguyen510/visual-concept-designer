# Example Prompt: Lessons Recap

Selected style: SB - Sketchnote Blue.

Create a 16:9 notebook-page sketchnote in navy blue ballpoint pen (`#1F3C88`) on white paper, hand-drawn, matching the SB template style.
