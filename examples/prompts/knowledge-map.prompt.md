# Example Prompt: Knowledge Map

Selected style: VTK - Visual Thinking Knowledge.

Create a 16:9 hand-drawn black ink (`#222222`) knowledge map on white paper, matching the VTK template style, with one orange accent (`#E8762C`) for emphasis only.
...
Signature: `#signature` at the bottom-right corner, small, faded ink.
